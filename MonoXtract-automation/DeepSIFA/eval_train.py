...
def get_cfg(fold):
    ...
    parser.add_argument('--val_csv_dir', type=str, default='D:/1DeepSIFA/data/mlkl/train/v1/5折交叉验证_42/train_fold{}_多标签.csv'.format(fold))

    parser.add_argument('--results_dir', default='./logs_train验证/', type=str, metavar='FILENAME', help='Output csv file for validation results (summary)')
